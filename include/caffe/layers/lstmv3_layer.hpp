//
// Created by wss on 2021/10/22.
//

#ifndef CAFFE_LSTMV3_LAYER_HPP
#define CAFFE_LSTMV3_LAYER_HPP
...
namespace caffe {
    ...
    class LSTMV3Layer : public Layer<Dtype> {
    public:
        explicit LSTMV3Layer(const LayerParameter& param)
                : Layer<Dtype>(param) {}
